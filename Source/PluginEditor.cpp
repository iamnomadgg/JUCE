...
juce::String RotarySliderWithLabels::getDisplayString() const
{
    ...
    {
        jassertfalse; //This case shouldn't happen!
    }
...
void PathProducer::process(juce::Rectangle<float> fftBounds, double sampleRate)
{
    ...
    */
    ...
    /*
    * 48000 / 2048 = 23 Hz -> this is the bin width
    */
...
void ResponseCurveComponent::resized()
{
    ...
    for (auto gaindB : gain)
    {
        ...
        g.setColour( gaindB == 0.f ? Colour(0u, 172u, 1u) : Colours::darkgrey );
    ...
    for (auto gaindB : gain)
    {
        ...
        g.setColour(gaindB == 0.f ? Colour(0u, 172u, 1u) : Colours::lightgrey);
